        ...
        if (!this.state.detailedView) {
            deleteQuestionView = (
                <form className="card bg-light" noValidate>
                    <h1 className="card-header">Delete Existing Question ({this.props.questionType})</h1>
                ...
                deleteQuestionView = (
                    <div>
                        ...
                        <QuestionForm title="Question Details" data={this.state.searchResults}
                            submitButtonText="Delete" cancelButtonText="Revert Changes"
                            submitEvent={(questionData) => this.deleteQuestion(questionData)}/>
                    </div>
                )
            }
        }
